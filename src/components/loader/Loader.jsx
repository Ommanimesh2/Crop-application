...
function Loader() {
  return (
    <div>
      <div classNameName="svg-wrapper">
   <svg className="moon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111.77 111.77">
   ...
   <svg className="moon-satelite" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111.8 111.8">
